...
### [Охотник за загадочными числами](https://github.com/vypiemzalyubov/qa-automation/blob/main/Selenium/Selenium%20Python/4.%20Windows%20and%20Tabs/task_7.py)
...
### [Откройте сокровища интернета](https://github.com/vypiemzalyubov/qa-automation/blob/main/Selenium/Selenium%20Python/4.%20Windows%20and%20Tabs/task_8.py) 
...
### [Погружение во фреймы](https://github.com/vypiemzalyubov/qa-automation/blob/main/Selenium/Selenium%20Python/4.%20Windows%20and%20Tabs/task_9.py)

Вы — кибердетектив, и перед вами стоит необычная загадка. В цифровом мире скрыт ключ к таинственному сейфу. Этот ключ спрятан в одной из цифровых комнат — iframe'ах. Ваша задача — проявить свои навыки и найти этот ключ. Но будьте осторожны, не каждая комната даст вам ответ!
